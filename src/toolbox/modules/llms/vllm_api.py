...
class CustomOpenAIforVLLM:
    ...
    def completions(self, prompt_list, stream=False, n_threads=1, **kwargs):
        """
...
if __name__ == "__main__":
    ...
    model = CustomOpenAIforVLLM("https://vllm.local.qkv.link", model_name, device="cuda:0", api_key="vllm-test-12345")
    ...
    response = model.completion(prompt, max_tokens=0, temperature=0.0, logprobs=0, echo=True)
