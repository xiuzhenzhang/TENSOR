...
from src.TPP.model.sahp_text.transformers import TransformerEncoder
...
class SAHP(nn.Module):
    ...
    def forward(
        ...
        """
        history = self.history_encoder(time_history, marks_history, text_emb_history, mask_history, custom_marks_history)
