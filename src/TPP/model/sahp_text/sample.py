...
def sampling_by_its_for_tm(self, time_history, marks_history, text_emb_history, mask_history, number_of_total_samples, step, mean, std):
    sample_rate_list = step_split(number_of_total_samples, step)
    ...
    def bisect_target(taus, probability_threshold):
        ...
        (
            ...
            _,
        ) = self.model(time_history, taus, marks_history, text_emb_history, mask_history, num_dimension_prior_batch=1)
        # [sample_rate, batch_size, seq_len, num_marks]
