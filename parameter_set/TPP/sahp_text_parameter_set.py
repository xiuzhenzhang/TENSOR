...
# io_dataset_name = ['Cuba', 'Bangladesh', 'Qatar', 'Armenia', 'Ecuador', 'Egypt', 'Thailand', 'Catalonia', 'Iran_1', 'Ghana', 'Russia_4', 'Iran_2', 'Iran_5', 'Venezuela_1', 'Spain', 'China_2', 'Iran_4', 'Iran_3', 'Russia_5', 'Russia_2']
io_dataset_name = ['Russia_1']
    ...
    "static":
     {
         ...
         "dtype": model_dtype,
         "compile": compile_or_not,
         "training_data_name": "emb_train",
         "evaluate_data_name": "emb_evaluate",
         "test_data_name": "emb_test",
...
io_evaluate_dataloader_name = 'generic_text_label'
